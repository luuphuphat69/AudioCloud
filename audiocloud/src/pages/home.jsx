...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const fetchToken = async () => {
            try {
                const response = await axios.get('http://3.106.53.25:8000/getcookie', { withCredentials: true }); // Get Cookies data
        ...
        const fetchData = async () => {
            if (genre) {
                try {
                    ...
                    const response = await axios.get(`http://3.106.53.25:8000/v1/audio/getTop50/${genre}`);
