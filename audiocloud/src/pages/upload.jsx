...
const Upload = () => {
    ...
    useEffect(() => {
        const fetchToken = async () => {
            try {
                ...
                const User = await axios.get(`http://3.86.36.56:8000/v1/user/get-info/${user.userId}`);
                setUser(User.data);
    ...
    const getTracks = async () => {
        const response = await axios.get(`http://3.86.36.56:8000/v1/audio/getTracks/${userId}`);
    ...
    const handleFileUpload = async () => {
        getTracks().then((result) => {
            ...
            if (!user.isPro && result >= 10) {
                ...
                axios.post(`http://3.86.36.56:8000/v1/audio/postAudio/${userId}`, formData, {
                    method: "POST",
                    credentials: "include",
                    headers: {
