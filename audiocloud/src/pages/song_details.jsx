...
const Details = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://3.105.51.135:8000/v1/comment/get-comments/${audioId}`);
    ...
    useEffect(() => {
        ...
        const fetchToken = async () => {
            try {
                ...
                const userDataResponse = await axios.get(`http://3.105.51.135:8000/v1/user/get-info/${_user.userId}`, { withCredentials: true });
    ...
    useEffect(() => {
        ...
        axios.get(`http://3.105.51.135:8000/v1/audio/getAudioInfo/${audioId}`)
            .then(response => {
    ...
    const handleSubmit = async () => {
        ...
        await axios.post('http://3.105.51.135:8000/v1/comment/post', formData, {
            method: "POST",
            headers: {
