...
const PopupForm = ({ closePopup }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://3.106.60.118:8000/v1/user/get-info/${userId}`, { withCredentials: true });
  ...
  const handleChanges = async () => {
    ...
    axios.put(`http://3.106.60.118:8000/v1/user/edit/${userId}`, formData, {
      method: "PUT",
      credentials: "include",
      headers: {
