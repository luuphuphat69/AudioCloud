...
const NavbarLoggedIn = () => {
    ...
    const handleLogOut = () => {
        document.cookie = "token=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=.3.86.36.56";
    ...
    const handleSearch = async (e) => {
        ...
        try {
            const response = await axios.get(`http://3.86.36.56:8000/v1/audio/search?queries=${searchTerm}`);
            const response2 = await axios.get(`http://3.86.36.56:8000/v1/playlist/search?queries=${searchTerm}`);
