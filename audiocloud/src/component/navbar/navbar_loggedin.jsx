...
const NavbarLoggedIn = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            const response = await axios.get(`http://3.106.53.25:8000/v1/audio/search?queries=${searchTerm}`);
            const response2 = await axios.get(`http://3.106.53.25:8000/v1/playlist/search?queries=${searchTerm}`);
