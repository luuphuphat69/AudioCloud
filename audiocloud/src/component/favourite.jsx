...
const Favourite = () => {
    ...
    useEffect(() => {
        const fetchToken = async () => {
            try {
                ...
                const responseData = await axios.get(`http://3.106.53.25:8000/v1/fav/get-list-fav/${_user?.userId}`);
    ...
    const handleRemove = async (audioId, userId) => {
        await axios.put(`http://3.106.53.25:8000/v1/fav/remove/${audioId}/${userId}`);
        removeItem(audioId);
        setNotify(true);
    }
