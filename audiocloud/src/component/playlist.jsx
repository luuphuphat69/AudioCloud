...
const Playlists = () => {
    ...
    useEffect(() => {
        const fetchToken = async () => {
            try {
                ...
                const responseData = await axios.get(`http://localhost:8000/v1/playlist/get-user-playlist/${_user?.userId}`);
    ...
    const handleRemove = async (playlistId) => {
        await axios.delete(`http://localhost:8000/v1/playlist/delete/${playlistId}`);
