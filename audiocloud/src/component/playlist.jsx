...
const Playlists = () => {
    ...
    useEffect(() => {
        const fetchToken = async () => {
            try {
                ...
                const responseData = await axios.get(`http://3.106.60.118:8000/v1/playlist/get-user-playlist/${_user?.userId}`);
    ...
    const handleRemove = async (playlistId) => {
        await axios.delete(`http://3.106.60.118:8000/v1/playlist/delete/${playlistId}`);
